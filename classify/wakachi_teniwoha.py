...
def main():
    ...
    files = glob.glob('/home/alice_tea_party/TextGeneratorPytorch/Yasuoka/data_proofreading/*.txt')
    print(files)
    ...
    for file in files:
        ...
        save_file('/home/alice_tea_party/TextGeneratorPytorch/Yasuoka/data/' + basename, lines)
