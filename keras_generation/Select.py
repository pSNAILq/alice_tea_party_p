...
class FileIO:
    ...
    def __init__(self):
        ...
        self.list = []#[loss,文章]のタプルが格納されるリスト

    def save_text(self,loss,sentense):
        """文章を保存する
        質の良い文章を任意の数保存する
        Args:
    ...
    def output(self):
        ...
        new_dir_path = env+path+file_name
        ...
        for i in range(SAVE_SIZE):
            ...
            #出力用にテキストを変換する newline="\n"　削除
            with open(new_dir_path+str(i)+".txt",mode ='w',encoding='utf-8') as f:
